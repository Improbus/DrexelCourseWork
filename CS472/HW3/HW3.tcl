...
#set tcp1 [$ns create-connection TCP $n2 TCPSink $n5 42]
#$tcp1 set window_ 32
...
# Step 3. - Create a TCP connection
# - Reno Create the connection between node 2 and node 5
#set tcp1 [$ns create-connection TCP/Reno $n2 TCPSink $n5 42]
#$tcp1 set window_ 32
# - And color it BLUE for readability
#$tcp1 set class_ 2
#$ns color 2 Blue
...
# Step 3. - Create a TCP connection
# - NewReno Create the connection between node 2 and node 5
#set tcp1 [$ns create-connection TCP/Newreno $n2 TCPSink $n5 42]
#$tcp1 set window_ 32
# - And color it BLUE for readability
#$tcp1 set class_ 2
#$ns color 2 Blue
...
# Step 3. - Create a TCP connection
# - VEGAS Create the connection between node 2 and node 5
set tcp1 [$ns create-connection TCP/Vegas $n2 TCPSink $n5 42]
$tcp1 set window_ 32
# - And color it BLUE for readability
$tcp1 set class_ 2
$ns color 2 Blue
