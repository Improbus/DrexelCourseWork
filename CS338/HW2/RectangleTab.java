...
public class RectangleTab implements ActionListener , ItemListener, KeyListener{
	...
	public JTextField getXSize() {
		return xSize;
	}

	public void setXSize(JTextField size) {
		xSize = size;
	}
	...
	public void setXSizeLabel(JLabel sizeLabel) {
		xSizeLabel = sizeLabel;
	}

	public JTextField getYSize() {
		return ySize;
	}

	public void setYSize(JTextField size) {
		ySize = size;
	}
	...
	public void setYSizeLabel(JLabel sizeLabel) {
		ySizeLabel = sizeLabel;
	}
